...
for i in range(0,N_TIMES):
  ...
  train_tweets, train_labels, test_tweets, test_labels = db_mgr.select_tweets(limit=20000, state_fips=True, table="us_tweets", split=0.8, label=state_fips)
  ...
  for k in sorted(classifiers):
    ...
    # pickle.dump( knn, open( "classifier-"+str(k)+".p", "wb" ) )
